...
//  FDTIn         Final departure time after search.
...
//         XXXXXX XXXXXXXXXXXXXXXXXX      XXXXXX XXXXXXXXXXXXXXXXXX
    ...
    set line to line+1.
    print "                               Steps:                   " at (0,line).
    set StepsLine to line. set line to line+1.
    ...
    print "BnDv:                          FDTme:                   " at (0,line).
    set BnDvLine to line. set FDTmeLine to line. set line to line+1.
...
//    - This is to display the datas that keep changing.
    ...
    if BurnStartTStmp = timestamp(0.0)
...
// Update the search results data.
    ...
    local FDTimeFormatted to "Y"+FDTme:year+"D"+FDTme:day+" "+FDTme:clock.

    print MFDVal(FDTimeFormatted) at (Col2Col,FDTmeLine).
