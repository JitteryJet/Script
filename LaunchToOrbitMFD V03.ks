...
//
// Update History:
//    01/12/2023 V02  - I do not know what happened to version V01.
//                      This is the version that was tested.
//                    - Add maximum airspeed.
//                    - Rearrange AUTOPILOT columns.
//    25/06/2024 V03  - Remove maximum airspeed.
//                    - Add Linear-tangent Steering info.
//                    -
//
...
//  TurnP         Gravity Turn Initial Pitchover (deg).
...
//  LTSDu         Linear-tangent Steering Turn duration (s).
//  LTSAn         Linear-tangent Steering Turn final angle (deg).
//
@lazyglobal off.
...
local LTSDuLine to 0.
local LTSAnLine to 0.
...
//         XXXXXX XXXXXXXXXXXXXXX      XXXXXX XXXXXXXXXXXXXXX
    ...
    set line to line+1.
    print "Stage:                      Stat:                " at (0,line).
    set StageLine to line. set StatLine to line. set line to line+1.
    print "Pitch:                      TurnS:               " at (0,line).
    set PitchLine to line. set TurnSLine to line. set line to line+1.
    print "--------ORBIT---------      TurnP:                " at (0,line).
    set TurnPLine to line. set line to line+1.
    ...
    print "                            LTSDu:                " at (0,line).
    set LTSDuLine to line. set line to line+1.
    print "                            LTSAn:                " at (0,line).
    set LTSAnLine to line. set line to line+1.
    ...
    print MFDVal(round(LTSDu,1) + " s") at (Col2Col,LTSDuLine).
    print MFDVal(round(LTSAn,3) + char(176)) at (Col2Col,LTSAnLine).
