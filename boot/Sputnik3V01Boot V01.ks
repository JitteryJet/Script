// Name: Sputnik3V01Boot
// Author: JitteryJet
// Version: V01
// kOS Version: 1.6.0.1
// KSP Version: 1.12.5
// Description:
//    Boot script for the Sputnik 3 satellite.
//
// Assumptions:
...
// it's stage separation before switching the game focus
// to the satellite. There is only one active staging
...
if ship:status = "FLYING"
  ...
  or ship:status = "ORBITING"
  {
    ...
    runoncepath
      (
        "archive:/KSP RP-1 kOS Firstplay/FlySputnik3V01 V01"
      ).
  }