...
// KSP Version: 1.11.2
// Description:
//    Multi-function Display (MFD) for the CaptureOrbit program.
//
//Notes:
//    - Coded using Delegates.
//    - Current vessel only ie the vessel running the calling program.
//    - It should be possible to call this script from programs other than CaptureOrbit,
//      but it was designed with CaptureOrbit in mind.
...
//  CBody         Name of the capure body.
//
@lazyglobal off.
//{
// Expose the delegates.
global CaptureOrbitMFD to lexicon
    (
...
//           XXXXXX XXXXXXXXXXXXX      XXXXXX XXXXXXXXXXXXX
      ...
      print "                                              " at (0,line).
      set line to line+1.
      print "Function: Capture Orbit                       " at (0,line).
      set line to line+1.
      print "Vessel Name:                                  " at (0,line).
      set NameLine to line. set line to line+1.
      print "-----VESSEL---------      ------AUTOPILOT-----" at (0,line).
      set line to line+1.
      print "Ap:                       CBody:              " at (0,line).
      set ApLine to line. set CBodyLine to line. set line to line+1.
      print "Pe:                                           " at (0,line).
      set PELine to line. set line to line+1.
      print "TSOI:                     Stat:               " at (0,line).
      set TSOILine to line. set StatLine to line. set line to line+1.
  ...
  local function DisplayBody
    {
// Display the capture body.
      parameter CBody.

      print CBody:padright(ColSize) at (Col2Col,CBodyLine).
    }
...
//    - This is to display the datas that keep changing.
      ...
      print MFDVal(round(TSOI,1)+" s") at (Col1Col,TSOILine).
